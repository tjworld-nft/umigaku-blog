...
export const mangaEpisodes: MangaEpisode[] = [
  ...
  { slug: 'drysuit-prep', ep: 21, short: 'ウェットの海を、潜り切ろう。ドライの支度は、いまのうちに', lead: 'ドライスーツの選び方と準備（採寸・レンタル・サイズ）をまんがで',
    keywords: ['ドライスーツ', 'ドライ', '採寸', '衣替え', '9月', '10月', '冬', 'サイズ', 'オーダー', '3本'] },
  { slug: 'solo-diving', ep: 22, short: 'ひとりで来ていいの？', lead: 'ダイビングの一人参加の不安（当日・送迎・着替え・相談）をまんがで',
    keywords: ['一人', 'ひとり', '一人参加', 'お一人', 'ソロ', '送迎', '三崎口', '少人数', '初めて', '不安'] },
]
